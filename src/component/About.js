...
import Hizkia_Parhusip from '../img/Hizkia_Parhusip.JPG'
...
const About = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-5 mb-20">
             <h3 className="text-green-700 text-xl lg:text-3xl mt-1 text-center font-bold ">About CryptoMania</h3>
           <div className="container rounded-md md:w-5/6 mt-4 bg-green-500 mx-auto text-white px-4 py-4">

           <p className=" text-xl mt-4 text-center font-normal ">This website can be used to find out the price of cryptocurrencies and also the latest news about cryptocurrencies</p>
            ...
            <img src={Hizkia_Parhusip} alt="gambar ayank" className="w-28 mx-auto h-28 object-cover rounded-full" />
            
            <p className="text-center text-sm md:text-base text-white mt-4 font-bold">&copy; 2021 Hizkia Parhusip</p>
